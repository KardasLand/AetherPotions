...
import com.kardasland.aetherpotions.utility.*;
...
import com.kardasland.aetherpotions.utility.potions.VersionMatcher;
...
public final class AetherPotions extends JavaPlugin {
    ...
    private PotionMetaWrapper metaWrapper;
    private ProtectionHandler protectionHandler;
    private PotionCache potionCache;
    ...
    public void onEnable() {
        ...
        initHooks();
        initWrapper();
        this.potionCache = new PotionCache();
        potionCache.loadAll();
    ...
    private void initWrapper() {
        this.metaWrapper = versionMatcher.match();
    }
    ...
    private void initCommands() {
        Objects.requireNonNull(getCommand("com/kardasland/aetherpotions")).setExecutor(new AetherCommand());
        Objects.requireNonNull(getCommand("com/kardasland/aetherpotions")).setTabCompleter(new AetherTabCompleter());
    }
